...
import { trpc } from "@/server/client"; // Assurez-vous que le chemin est correct

import CustomersTable from "@/components/customersTables"; // Mettez à jour si nécessaire
