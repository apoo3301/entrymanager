...
//         } else {
//           setEmailMessage(`Failed to send email: ${response.message}`);
//         }
//       } catch (error) {
//         setEmailMessage(`Error: ${(error as Error).message}`);
//       } finally {
//         setIsSending(false);
//       }
//     }
          ...
          <CardContent className="grid gap-4">
            ...
            <div className="grid gap-2">
              ...
              <DropdownMenu>
                ...
                {/* <DropdownMenuContent align="start">
                  <DropdownMenuItem onClick={handleActionSelect}>
                    Send Email
                  </DropdownMenuItem>
                </DropdownMenuContent> */}
              </DropdownMenu>
